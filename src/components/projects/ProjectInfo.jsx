const ProjectInfo = ({ project }) => {
	// Safely destructure ProjectInfo and set default values to avoid errors
	const { ProjectInfo } = project;
	...
	return (
	  <div className="block sm:flex gap-0 sm:gap-10 mt-14">
		<div className="w-full sm:w-1/3 text-left">
		  ...
		  {ProjectInfo && ProjectInfo.ClientHeading && (
			<div className="mb-7">
		  ...
		  {ProjectInfo && ProjectInfo.ObjectivesHeading && (
			<div className="mb-7">
		  ...
		  {ProjectInfo && ProjectInfo.SocialSharingHeading && (
			<div>
			  <p className="font-general-regular text-2xl font-semibold text-ternary-dark dark:text-ternary-light mb-2">
				{ProjectInfo.SocialSharingHeading}
			  </p>
			  <div className="flex items-center gap-3 mt-5">
				{ProjectInfo.SocialSharing &&
