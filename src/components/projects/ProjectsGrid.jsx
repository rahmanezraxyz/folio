...
import SkeletonCard from "../SkeletonCard"; // Pastikan kamu buat file ini

const ProjectSingle = lazy(() => import("./ProjectSingle"));
...
const ProjectsGrid = () => {
  ...
  const renderProjects = (projectList) =>
    projectList.map((project) => (
      <Suspense fallback={<SkeletonCard />} key={project.id}>
        <ProjectSingle
          title={project.title}
